...
const Home = ({
  ...
  return (
    <div
      className="z-0 bg-[rgb(36,36,36)] text-white h-screen snap-y snap-mandotory 
      ...
      <Link href="#hero">
        <footer className="sticky bottom-9 w-full cursor-pointer ">
          <div className="flex items-center justify-center ">
            <img
              className="h-10 w-10 rounded-full object-cover filter grayscale hover:grayscale-0 cursor-pointer"
