            ...
            <div className='relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20'>
             ...
             justify-center p-20 md:p-44 h-screen'>
                        ...
                        <div className='space-y-10 px-0 md:px-10 max-w-6xl'>
                            ...
                            <p className='text-lg text-center md:text-left'>lkncinwpkojpkdjpodjwpihlkncinwpkojpkdjpodjwpihlknci
                                nwpkojpkdjpodjwpihlkncinwpkojpkdjpodjwpihlkncinwpkojpkdjp
                                odjwpihlkncinwpkojpkdjpodjwpih</p>
                        </div>
                    </div>
                ))}
            </div>
