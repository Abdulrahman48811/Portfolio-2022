...
function Skill({ skill, directionLeft }: Props) {
    ...
    ease-in-out group-hover:bg-black h-24 w-24 md:w-28 md:h-28 xl:w-32 xl:h-32 rounded-full z-0'>
                <div className="flex items-center justify-center h-full">
                    <p className='text-2xl font-bold text-white opacity-100'>{skill.progress}%</p>
                </div>
            </div>
        </div>
    )
