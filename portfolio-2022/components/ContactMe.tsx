      ...
      <div className="flex flex-col space-y-10">
        ...
        <div className="space-y-10">
          <div className="flex items-center space-x-5 justify-center">
            ...
            <p className="text-1xl sm:text-2xl font-serif ">
          ...
          <div className="flex items-center space-x-5 justify-center">
            ...
            <p className="text-1xl sm:text-2xl font-serif">{pageInfo?.email}</p>
          </div>
        ...
        <form
          ...
          className="flex flex-col space-y-2 w-fit mx-auto sm:text-lg text-xs"
        >
